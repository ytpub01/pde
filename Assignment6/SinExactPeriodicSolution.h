...
//
// The initial data implemented is the function sin((2 pi (x-xA))/(xB-xA)).
// 
...
public :
	...
	pStar = exp(-4*pow((3.1415926535897932385),2)*(-a)*t)*initialFunction(x); 
    ...
    //
    // The initial function is sin((2 pi (x-xA))/(xB-xA)),
    ...
    double initialFunction(double pStar)
    {
        ...
        return sin(2.0*3.1415926535897932385*s);
    }
